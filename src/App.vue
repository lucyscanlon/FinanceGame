<template>
  ...
  <div v-if="(manageMainGameNav.currentPage >= 0) && (manageMainGameNav.currentPage < 23)" class="wholegame-wrapper">
    <CharacterStatsSidebarWrapper></CharacterStatsSidebarWrapper>
    <MainGameWrapper></MainGameWrapper>
  </div>
  <div v-if="manageMainGameNav.currentPage === 23" class="startingpage-whole-container">
