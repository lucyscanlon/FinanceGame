...
export const supermarketChoiceStore = defineStore({
  ...
  actions: {
    ...
    confirmSupermarketChoice() {
      ...
      console.log(
        "Confirmed Supermarket Choice: " + this.chosenSupermarketInfo.SMName
      );
    },
  },
});
...
export const transportChoiceStore = defineStore({
  ...
  actions: {
    ...
    updatedCurrentlyChosenTransport(name, desc, total) {
      ...
      console.log(
        "Currently selected transport choice: " +
          this.currentlySelectedTransportChoice.TName
      );
    },
    ...
    confirmChosenTransport() {
      ...
      console.log(
        "Confirmed transpose choice: " + this.chosenTransportChoice.TName
      );
    },
  },
});
