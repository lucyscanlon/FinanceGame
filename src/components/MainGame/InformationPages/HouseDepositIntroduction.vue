...
<template>
    <div class="rentintro-mainwrapper supermarket-info-wrap">
        <div v-if="manageMainGameNav.currentPage === 25" @click="useMainGameplayNav.navigateToPage(11), manageGameTimer.startCountdown()" class="exitout-introduction-button-container">
        ...
        <div class="homedeposit-description-wrapper">
            ...
            <button
              @click="manageSound.playClickSound(), manageHouseDeposit.confirmHouseDepositChoice(), useMainGameplayNav.navigateToPage(11), manageGameTimer.startCountdown(), useMainGameplayNav.unlockComponent()">
              Confirm Choice
            </button>
          </div>
            </div>
