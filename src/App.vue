<template>
  ...
  <div v-if="(manageMainGameNav.currentPage >= 0) && (manageMainGameNav.currentPage < 27)" class="wholegame-wrapper">
    <CharacterStatsSidebarWrapper></CharacterStatsSidebarWrapper>
    <MainGameWrapper></MainGameWrapper>
  </div>
  <div v-if="manageMainGameNav.currentPage === 27" class="startingpage-whole-container">
