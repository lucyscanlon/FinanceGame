...
<template>
    <div class="map-display-wrapper">
        ...
        <LivingOptionsDisplay streetAddress="19 Rodeo Square" districtDesc="Nebula Plaza" homeDesc="A luxury apartment, the other side of town" :rent=700 :commute=2 classtag="rodeo19" :deposit=812.50 :increasePerc=875.00 :decreasePerc=30></LivingOptionsDisplay>
