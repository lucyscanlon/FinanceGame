...
<template>
  <div class="rentintro-mainwrapper">
    ...
    <div class="emergencyfund-description-wrapper">
      <div
        :class="currentSlide !== 0 && 'pensionSlideInactive'"
        class="pension-slidecontainer"
      >
        ...
        <div class="rentintro-list emergencyfund-list-intro pensionslideactive">
          <ul>
            <li>
              An emergency fund is an amount of money that is set aside to deal
              with
              <span class="colour-green"
                >unexpected or unplanned financial circumstances</span
              >.
            </li>
            <li>
              These circumstances can range from
              <span class="colour-green">unexpected bills</span>,
              <span class="colour-green">home or car repairs</span>, or
              <span class="colour-green"
                >replacement of essential electronics</span
              >.
            </li>
            <li>
              Your emergency fund can be used for large or small payments which
              are not normally part of your monthly outgoings.
            </li>
            <li>
              Emergency funds can protect you from building up
              <span class="colour-green">debt</span>.
            </li>
          </ul>
        </div>
      </div>
      <div
        :class="currentSlide !== 1 && 'pensionSlideInactive'"
        class="pension-slidecontainer"
      >
        ...
        <div class="rentintro-list emergencyfund-list-intro pensionslideactive">
          <ul>
            <li>
              Keep the money in a place that is
              <span class="colour-green">easily accessible</span> - you never
              know when you will need it!
            </li>
            <li>
              You can choose to store your fund in a
              <span class="colour-green">high interest savings account</span>,
              meaning your money can grow even more over time from interest.
              Some accounts may need an
              <span class="colour-green">initial deposit</span> to set up,
              always check the requirements.
            </li>
            <li>
              Don't invest the money in stocks and shares - This way the value
              of your emergency fund will not be subject to market fluctuations.
            </li>
            <li>
              Only use the fund for
              <span class="colour-green">true emergencies</span> and remember to
      ...
      <div
        :class="currentSlide !== 2 && 'pensionSlideInactive'"
        class="pension-slidecontainer"
      >
